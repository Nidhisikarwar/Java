...
class BscStudent extends Student{
    ...
    BscStudent(String n, String fn, int a,double p,int rn,String sub,int y,String dur){
        super(n, fn, a, p, rn, sub);
        year=y;
        duration=dur;
    }
    BscStudent(BscStudent ob){
        super(ob);
        year=ob.year;
...
class Profile{
    ...
    BscStudent s1=new BscStudent("nidhi","om",18,91.00,16,"java",2023,"3years");
    BscStudent s2=new BscStudent("siddhi","vinod",19,50.00,23,"java",2023,"3years");
    BscStudent s3=new BscStudent("neha","puran",19,95.00,15,"java",2023,"3years");
    BscStudent s4=new BscStudent();
