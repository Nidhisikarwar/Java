...
System.out.println(" first class calling method:"+ref.call());
ref=ob2;//refers to a A object
System.out.println(" second class calling method:"+ref.call());
ref=ob3;//refers to a B object
System.out.println(" third class calling method:"+ref.call());
}
}
