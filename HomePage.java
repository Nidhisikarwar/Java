...
public class HomePage extends JFrame implements ActionListener {
    ...
    public HomePage() {
       ...
       /*  JMenu rigidMenu = new JMenu();
        rigidMenu.add(Box.createRigidArea(new Dimension(400, 100)));
        rigidMenu.setEnabled(false);
        menuBar.add(rigidMenu);*/
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/books.png"));
